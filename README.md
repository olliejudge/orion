...
With the Apple secrets set, the release also signs and notarizes the macOS binaries; without them it ships them unsigned. [docs/RELEASING.md](docs/RELEASING.md) has the one-time setup for the tap token and the Apple secrets, and how to check a signed release.
